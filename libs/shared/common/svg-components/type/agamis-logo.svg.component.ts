...
import Color from '../../../../../apps/workspace-ui/src/app/common/color';

@Component({
  standalone: true,
  selector: 'agamis-ws-svg-agamis-logo',
  // templateUrl: '../../../assets/images/svg/agamis-logo.svg',
  template:`<svg xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="27.093"
  ...
  <g id="shape-5dcde3bf-4b3e-800c-8003-26d1e0ecbbde">
    <g class="fills" id="fills-5dcde3bf-4b3e-800c-8003-26d1e0ecbbde">
      <path class="cls-1" rx="0" ry="0"  [attr.fill]="fillColor" style="fill-opacity:1"
